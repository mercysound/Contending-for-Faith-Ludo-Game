...
// blinkBackground()
  ...
  if (coming === 1) {
    ...
    if (computerTurn == true) {
      ...
      myTurn = false;
      $("#modal22").modal("hide");
      alert("Bonus! It's " + secondPersonPlaying + " turn turn to play once more");
    ...
    if (computerTurn == true) {
      ...
      computerTurn = false;
      myTurn = true;
      alert("It's " + firstPersonPlaying + " turn turn to play");
      ...
      myTurn = false;
      computerTurn = true;
      alert("It's " + secondPersonPlaying + " turn turn to play");
      //document.querySelector(".d-none24").style.display = "none";
      confirmAnsObj.modalshow24 = false;
    }
  } else if (coming === 26) {
